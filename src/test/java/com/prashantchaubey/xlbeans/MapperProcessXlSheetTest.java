...
import com.prashantchaubey.xlbeans.beans.TestBean;
...
public class MapperProcessXlSheetTest {
  ...
  private static Method processXlSheet;
  ...
  public static void init() throws NoSuchMethodException, SecurityException {
    ...
    path =
        Paths.get(
            MapperProcessXlSheetTest.class
                .getClassLoader()
                .getResource("data.xlsx")
                .getFile()
                .substring(1));
  }
  ...
  public void test1()
    ...
    validateAndConfigurePath.invoke(
        ...
        path,
        TestBean.class,
        new MappingOptionsBuilder().setStartingPosition(new Index(-1, -1)).build(),
        null);
  ...
  public void test2()
    ...
    Mapper<TestBean> mapper = new Mapper<>();
    validateAndConfigurePath.invoke(
        mapper, path, TestBean.class, new MappingOptionsBuilder().setTargetSheet(-1).build(), null);
    createMapForXlBeanTypes.invoke(mapper, TestBean.class);
    InvocationTargetException ex =
        assertThrows(
            InvocationTargetException.class,
